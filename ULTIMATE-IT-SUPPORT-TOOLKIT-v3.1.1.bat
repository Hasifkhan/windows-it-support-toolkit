...
title HASIF KHAN - ULTIMATE IT SUPPORT TOOLKIT v3.1.1
color 0B
...
set "APP_VERSION=3.1.1 Professional Edition"
...
echo.
echo  ------------------------------------------------------------------
echo   IT SUPPORT TOOLKIT v3.1.1 ^| HASIF KHAN ^| %ADMIN_STATUS%
echo  ------------------------------------------------------------------
echo.
...
if /i "%choice%"=="3"  goto :NETWORK
if /i "%choice%"=="03" goto :NETWORK
